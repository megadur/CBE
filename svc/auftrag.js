...
mrouter.call(thisArg, "/:GUID/XHisAuftrag", "SELECT  'X_HIS_AUFTRAG' AS TBL, XH.*  \
...
mrouter.call(thisArg, "/:GUID/XAuftrag", "SELECT  'X_AUFTRAG' AS TBL, AU.*  \
FROM IDMA_AUFTRAGS_OPDB_DATA.X_ACCOUNT_INFO AI \
INNER JOIN IDMA_BESTANDS_OPDB_DATA.X_ACCOUNT A ON A.TO_NR=AI.TO_NR \
...
mrouter.call(thisArg, "/:GUID/XAuftragExt", "SELECT  'X_AUFTRAG_EXT ' AS TBL, AX.*  \
FROM IDMA_AUFTRAGS_OPDB_DATA.X_ACCOUNT_INFO AI \
INNER JOIN IDMA_BESTANDS_OPDB_DATA.X_ACCOUNT A ON A.TO_NR=AI.TO_NR \
...
mrouter.call(thisArg, "/:GUID/XAuftragExt2Sof", "SELECT  'X_AUFTRAG_EXT_2_SOF' AS TBL, A2S.*  \
FROM IDMA_AUFTRAGS_OPDB_DATA.X_ACCOUNT_INFO AI \
INNER JOIN IDMA_BESTANDS_OPDB_DATA.X_ACCOUNT A ON A.TO_NR=AI.TO_NR \
...
mrouter.call(thisArg, "/:GUID/XMessage", "SELECT  'X_MESSAGES' AS TBL, XM.*  \
FROM IDMA_AUFTRAGS_OPDB_DATA.X_ACCOUNT_INFO AI \
INNER JOIN IDMA_BESTANDS_OPDB_DATA.X_ACCOUNT A ON A.TO_NR=AI.TO_NR \
...
mrouter.call(thisArg, "/:GUID/XError", "SELECT  'X_ERROR' AS TBL, XE.*  \
FROM IDMA_AUFTRAGS_OPDB_DATA.X_ACCOUNT_INFO AI \
INNER JOIN IDMA_BESTANDS_OPDB_DATA.X_ACCOUNT A ON A.TO_NR=AI.TO_NR \
