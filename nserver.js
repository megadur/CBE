...
app.get('/bestand', function (req, res) {
    "use strict";
    ...
    oracledb.getConnection(connAttrs, function (err, connection) {
        ...
        connection.execute("SELECT 'BESTAND' AS TBL, B.* FROM IDMA_BESTANDS_OPDB_DATA.X_BESTAND B WHERE B.GUID='100049016041212390100001'", {}, {
